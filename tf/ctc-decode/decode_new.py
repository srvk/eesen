...
train_fil = open('/home/sdalmia/asr-test/lorelei-audio/egs/asr/s5c/201-haitian-flp/langmodel/train.txt').readlines()
units = open('/home/sdalmia/asr-test/lorelei-audio/egs/asr/s5c/201-haitian-flp/langmodel/units.txt').readlines()
lexicon = open('/home/sdalmia/asr-test/lorelei-audio/egs/asr/s5c/201-haitian-flp/langmodel/lexicon_numbers.txt').readlines()
lexicon_dict = {}
for i in lexicon:
...
def create_parser():
    ...
    path = "/home/sdalmia/asr-test/lorelei-audio/egs/asr/s5c/201-haitian-flp/"
    ...
    parser.add_argument(
        '--arkFile', default=path + "output_acoustic_char/OUT.1.ark",
    ...
    parser.add_argument(
        '--unitsFile', default=path+"data/local/dict_phn/units.txt"
    )
