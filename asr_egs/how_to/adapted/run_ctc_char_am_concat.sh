...
dir=exp/train_am_char_l${nlayer}_c${nhidden}_p${nproj}_sat_l$sat_nlayer
...
steps/train_ctc_tf.sh --learn-rate 0.0125 --half_after 6  --nlayer $nlayer --nproj $nproj --nhidden $nhidden --batch_size 16 --sat_type concat --sat_stage train_direct --continue_ckpt ./exp/train_am_char_l5_c200_p100/model/epoch08.ckpt --sat_path /data/ASR5/abhinav5/PlacesAlexNet_480h/final_feats  --max_iters 25 --sat_nlayer 2 ./data/train_tr95_fbank/ ./data/train_cv05_fbank/ $dir || exit 1;
