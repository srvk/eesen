...
if [ $stage -le 3 ]; then
  ...
  dir=exp/train_am_char_l${lstm_layer_num}_c${lstm_cell_dim}
  ...
  steps/train_ctc_tf.sh --num-sequence 16 --learn-rate 0.02 --half_after 6  --nlayer $nlayer --nproj $nproj --nhidden $nhidden --max_iters 25 ./data/train_tr95_fbank/ ./data/train_cv05_fbank/ $dir || exit 1;
