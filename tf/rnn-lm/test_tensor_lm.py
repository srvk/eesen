...
new_saver = tf.train.import_meta_graph('MODEL_1.ckpt.meta')
new_saver.restore(sess, tf.train.latest_checkpoint('./'))

#pdb.set_trace()

#saver.restore(sess, './MODEL_1.ckpt.data-00000-of-00001')
...
soff = sess.run(softmax, feed_dict={x_input: x_in, x_lens: x_lens_in})
    
pdb.set_trace()
#softmax = tf.nn.softmax(logits, dim=-1, name=None)
if (char not in w2i):
    print(1.0 / math.pow(10.0, 20.0))
else :
    print(softmax[w2i[char]])
