...
class RNN(object):
    def __init__(self,
        ...
        if initParams is not None:          # load parameters from given dict
            ...
            self.paramNames = ["Nlayers", "Ndirs", "Nx", "Nh", "Ny", "Ah", "Ay", "predictPer", "loss", "L1reg", "L2reg", "frontEnd"]
        ...
        self.aparams = [theano.shared(zeros(x.get_value().shape)) for x in self.params]
