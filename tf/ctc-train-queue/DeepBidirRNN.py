...
class DeepBidirRNN:
    ...
    def __init__(self, config, tr_feats, tr_labels, cv_feats, cv_labels):

        nfeat = config["nfeat"]
        nhidden = config["nhidden"]
        nclass = config["nclass"]
        print("this is the nclass: "+str(nclass))
        l2 = config["l2"]
        ...
        self.feats = tf.cond(self.is_training, lambda:tr_feats, lambda:cv_feats)
        self.labels = tf.cond(self.is_training, lambda:tr_labels, lambda:cv_labels)
