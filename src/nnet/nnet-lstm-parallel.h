...
#ifndef KALDI_NNET_LSTM_PARALLEL_H_
#define KALDI_NNET_LSTM_PARALLEL_H_
...
public:
    ...
    Component* Copy() const { return new LstmParallel(*this); }
    ComponentType GetType() const { return kLstmParallel; }
