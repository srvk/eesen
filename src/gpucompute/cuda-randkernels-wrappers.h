// gpucompute/cuda-randkernels-wrappers.h
...
#ifndef EESEN_GPUCOMPUTE_CUDA_RANDKERNELS_WRAPPERS_H_
#define EESEN_GPUCOMPUTE_CUDA_RANDKERNELS_WRAPPERS_H_

#if HAVE_CUDA == 1

#include "base/kaldi-error.h"
#include "gpucompute/cuda-randkernels.h"
