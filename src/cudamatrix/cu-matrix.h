...
class CuMatrixBase {
 public:
  ...
  /// [Yajie] Perform a CTC foward pass over a single sequence, computing the alpha values. Here, "rescale"
  ...
  /// [Yajie] Computing alpha values by processing multiple sequences at one time. 
  void ComputeCtcAlphaMSeq(const CuMatrixBase<Real> &prob,
                       int32 row_idx,
                       const std::vector<int32> &labels,
                       const std::vector<int32> &frame_num_utt);

  /// [Yajie] Perform a CTC backward pass over a single sequence, computing the beta values. Here, "rescale"
  /// is a boolean value indicating whether the scaling version is used.
  ...
  /// [Yajie] Computing beta values by processing multiple sequences at one time.
  ...
  /// [Yajie] Evaluate the errors from the CTC objective over a single sequence.  
 ...
 /// [Yajie] Evaluate the errors from the CTC objective over multiple sequences.
 void  ComputeCtcErrorMSeq(const CuMatrixBase<Real> &alpha,
  ...
  /// [Yajie] Evaluate the errors from the CTC objective with the rescaled alpha and beta values.
  void ComputeCtcErrorRescale(const CuMatrixBase<Real> &alpha,
                              const CuMatrixBase<Real> &beta,
                              const CuMatrixBase<Real> &prob,
                              const std::vector<int32> &labels,
                              const CuVectorBase<Real> &zt);

  /// [Yajie] Redistribute probabilities by labels
  void DistributeProbByLabel(const CuMatrixBase<Real> &prob,
                             const std::vector<int32> &labels);
