...
class FeatsReader(object):
    ...
    def __init__(self, info_set, data_dir, online_augment_config, extension):
        ...
        #TODO sat should have its own reader (that way they will be the slaves)
        if (info_set == 'train'):
            ...
            self.__read_test_or_sat(data_dir)
        else:
    ...
    #TODO this method will be deprecated soon (sat will have its own reader)
    ...
    def __read_test_or_sat(self, data_dir):
        ...
        if(count_augmented_folder == 0 and count_scp_files == 0):
            ...
            print("unilingual set up detected on test set language... \n")
            self.__process_language_folder(data_dir, constants.NO_LANGUAGE_NAME, True)
