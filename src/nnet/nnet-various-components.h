...
#ifndef KALDI_NNET_NNET_VARIOUS_COMPONENTS_H_
#define KALDI_NNET_NNET_VARIOUS_COMPONENTS_H_
...
class Splice: public Component {
 public:
  ...
  ComponentType GetTypeNonParal() const { return kSplice; }
...
class CopyComponent: public Component {
 public:
  ...
  ComponentType GetTypeNonParal() const { return kCopy; }
...
class AddShift : public UpdatableComponent {
 public:
  ...
  ComponentType GetTypeNonParal() const { return kAddShift; }
...
class Rescale : public UpdatableComponent {
 public:
  ...
  ComponentType GetTypeNonParal() const { return kRescale; }
...
#endif // KALDI_NNET_NNET_VARIOUS_COMPONENTS_H_
