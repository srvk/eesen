...
def create_parser():
    ...
    path = "/data/ASR5/fmetze/asr-test/lorelei-audio/egs/asr/s5c/504-amharic-v1-tf/log/dbr-run21-amharic-bible/"
    ...
    parser.add_argument(
        '--ctmOut', default="dbr-run21-lor17dryrun-amharic-bible.ctm",
