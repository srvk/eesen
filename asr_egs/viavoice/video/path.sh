...
if [[ `uname -n` =~ ip-* ]]; then
  ...
  export PYTHONPATH=/data/ASR5/ramons_2/sinbad_projects/youtube_project/am/eesen_video/tf/ctc-am:/data/ASR5/ramons_2/sinbad_projects/youtube_project/am/eesen_video/tf/char-rnn-lm/
