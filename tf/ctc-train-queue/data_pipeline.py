...
class DataPipeline:
    ...
    '''
    def __init__(self, data_dir, labels_file, batch_size, feats_dim, num_threads):
    ...
    def get_data_from_queue(self, input_queue):
        ...
        utterance[0].set_shape([None, self.feats_dim])
    ...
    def _setup_data_pipeline(self, scp_file, labels_file, batch_size, num_threads):
        ...
        #tf.summary.image('post-aug', self.video_batch[0,...], max_outputs=12)
